    ...
    <section className="py-2 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto">
          {/* Spiral Arrow on Left - Hidden on md and smaller screens */}
          <div className="absolute -left-20 top-1/2 transform -translate-y-1/2 hidden lg:block">
            <div className="text-sm text-gray-700 mb-4 max-w-xs">
          ...
          {/* Hero Video Dialog - Clean Video Player */}
          <div className="relative">
            <HeroVideoDialog
              animationStyle="top-in-bottom-out"
              videoSrc="https://www.youtube.com/embed/73UyWHzQ3ls"
              thumbnailSrc="https://img.youtube.com/vi/73UyWHzQ3ls/maxresdefault.jpg"
              thumbnailAlt="Next.js Starter Kit Demo Video"
